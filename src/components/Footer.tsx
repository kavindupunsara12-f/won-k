    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 py-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <img
                ...
                loading="lazy"
              />
              <span className="text-xl font-bold gradient-text">WON K</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Building exceptional web experiences, mobile apps, and AI solutions
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start space-x-2 text-sm text-muted-foreground">
                ...
                <span>Serving businesses nationwide across Sri Lanka</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-sm text-muted-foreground">
            © {currentYear} WON K. All rights reserved.
          </p>
